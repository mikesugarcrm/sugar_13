...
class PopupSmarty extends ListViewSmarty
{
    ...
    public function process($file, $data, $htmlVar)
    {
        ...
        $this->th->ss->assign('colCount', safeCount($this->displayColumns) + 1);
    ...
    public function setup(
        ...
        SugarACL::listFilter(
            $this->module,
            $this->searchForm->fieldDefs,
            ['owner_override' => true],
            ['use_value' => true, 'suffix' => '_advanced', 'add_acl' => true]
        );
        ...
        } elseif (isset($_REQUEST['request_data'])) {
