...
var ValidationProgressTracker = function(silent) {
    ...
    this.updateValidateButton = function() {
        if (!project.isBeingValidated) {
            ...
            $('#ButtonValidate > i').addClass('sicon sicon-lg sicon-check-circle-lg check-square-on');
        } else {

            // Validate button should be greyed out and have no action
            $('#ButtonValidate > i').addClass('sicon sicon-lg sicon-check-circle-lg check-square-off');
        }
    },
    ...
    this.updateErrorPaneToggleButton = function() {
        ...
        if ($('#Error-table > tbody > tr').length) {
            ...
            $('#ButtonToggleErrorPane > i').addClass('sicon sicon-lg sicon-warning-lg exclamation-triangle-on');
        } else {

            // Error pane toggle button should be greyed out and have no action
            $('#ButtonToggleErrorPane > i').addClass('sicon sicon-lg sicon-warning-lg exclamation-triangle-off');
        }
