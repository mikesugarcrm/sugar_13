...
class OracleManager extends DBManager
{
    ...
    protected $type_range = [
        'int' => ['min_value' => -99999999999999999999999999999999999999, 'max_value' => 99999999999999999999999999999999999999],
        ...
        'short' => ['min_value' => -999, 'max_value' => 999],// number(3)
        'tinyint' => ['min_value' => -999, 'max_value' => 999], // number(3)
    ];
    ...
    public function connect(array $configOptions = null, $dieOnError = false)
    {
        ...
        if (!empty($collation)) {
            $session_query .= "
            	NLS_COMP=LINGUISTIC
				NLS_SORT=$collation";
        } elseif ($this->getOption('enable_ci')) {
            $session_query .= '
            	NLS_COMP=LINGUISTIC
				NLS_SORT=BINARY_CI';
        }
    ...
    protected function generateCaseInsensitiveIndices($fieldDefs, $indices)
    {
        ...
        foreach ($indices as $key => $index) {
            ...
            foreach ($index['fields'] as $field) {
                ...
                if ($fieldDef
                    && !in_array($fieldDef['type'], ['id', 'enum'])
