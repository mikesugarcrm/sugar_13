...
class SubPanelTiles
{
    ...
    public $hidden_tabs = []; //consumer of this class can array of tabs that should be hidden. the tab name
    ...
    public function display($showContainer = true)
    {
        ...
        foreach ($tabs as $tab) {
            ...
            if (!$this->focus->ACLAccess('subpanel', ['subpanel' => $thisPanel])) {
                continue;
            }
