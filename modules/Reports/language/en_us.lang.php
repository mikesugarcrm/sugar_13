...
$mod_strings = [
    ...
    'LBL_SUMMATION_REPORT_DESC' => 'Create a tabular report that provides data for records matching the specified criteria. The data can also be shown within a chart.',
    ...
    'LBL_REFRESH_REPORT_RESULTS' => 'Refresh Results',
    ...
    'LBL_COPY_AS' => 'Duplicate as',
    'LBL_CURRENT_REPORT_TYPE' => 'Current Report Type',
// report_name
    ...
    'LBL_NO_ACCESS' => 'You are not able to access this report due to permission restrictions.',
    'LBL_SERVER_ERROR' => 'You are not able to access this report due to a server error.',
    ...
    'LBL_REPORTS_FOCUS_DRAWER_DASHBOARD' => 'Reports Focus Dashboard',
    ...
    // NEW REPORT VIEWER
    'LBL_REPORT_CHART' => 'Chart',
    'LBL_REPORT_TABLE' => 'Table',
    'LBL_REPORT_FILTERS' => 'Filters',
    'LBL_REPORT_DATA_TABLE' => 'Data Table',
    'LBL_REPORT_MINIMIZE' => 'Minimize',
    'LBL_REPORT_EXPAND' => 'Expand',
    'LBL_EXPORT_AS' => 'Export as',
    'LBL_EXPORT_TO_PDF' => 'PDF',
    'LBL_PDF_DESCRIPTION' => 'This file type is optimized for printing and sharing, and it cannot be easily edited. Report charts and tables are included.',
    'LBL_EXPORT_TO_CSV' => 'CSV',
    'LBL_CSV_DESCRIPTION' => 'This file type contains comma-separated data and can be opened in a spreadsheet application. It contains raw data but excludes report charts and tables.',
    'LBL_EXPORT_PDF' => 'Generating PDF',
    'LBL_EXPORT_CSV' => 'Generating CSV',
    'LBL_EXPORT_PDF_SUCCESS' => 'PDF generated successfully!',
    'LBL_EXPORT_CSV_SUCCESS' => 'CSV generated successfully!',
    'LBL_DATA_TABLE' => 'Data Table',
    'LBL_COLLAPSE_ALL' => 'Collapse All',
    'LBL_EXPAND_ALL' => 'Expand All',
    'LBL_TOTAL_COUNT' => 'Total Count',
    'LBL_REPORT_FILTER_UNAVAILABLE' => 'You do not have permissions to view one or more runtime filters',
    'LBL_UPDATES_SINCE_LAST_REFRESH' => 'This report has been modified since last refresh.',
    'LBL_EXPORT_FAILED' => 'The report is too large to export. To reduce the report size, please limit the data from related modules or use filters to narrow the results.',
    'LBL_SELECT_ALL' => 'Select All',
    'LBL_REPORTS_EXPORT_MESSAGE_TO_LARGE' => 'Data table is too large to load.',
    'LBL_REPORTS_EXPORT_TO_CSV_MESSAGE' => 'Adjust the filters to reduce the results or export the current results as a CSV file.',
    'LBL_SIMPLIFIED_REPORT_INFO' => 'Large data table. Adjust the filters to reduce the results or choose an option below.',
    'LBL_SIMPLIFIED_REPORT_INFO_2' => 'You can save the full result set as a CSV file or view the full result set in this panel as a simplified table.',
    'LBL_VIEW_SIMPLIFIED_TABLE' => 'View simplified table',
    'LBL_EXPORT_RESTRICTION_LARGE_REPORTS_MESSAGE' => 'Adjust the filters to reduce the results.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO' => 'Large data table. Adjust the filters to reduce the results or choose the option below.',
    'LBL_EXPORT_RESTRICTION_SIMPLIFIED_REPORT_INFO_2' => 'You can view the full result set in this panel as a simplified table.',
    'LBL_EXPORT_AS_CSV' => 'Export as CSV',
    'LBL_FILTER_VIEW' => 'Filter View',
    'LBL_TABLE_VIEW' => 'Table View',
    'LBL_CHART_VIEW' => 'Chart View',
    'LBL_VERTICAL_SPLIT_VIEW' => 'Vertical Split View',
    'LBL_HORIZONTAL_SPLIT_VIEW' => 'Horizontal Split View',
    'LBL_SHOWING' => 'Showing',
    'LBL_ONE_VIEW_REQUIRED' => 'Must select at least one view',
    'LBL_RC_NO_CHART' => 'Rows and columns reports do not support charts',
    'LBL_LINE_CHART_INVALID' => 'A line chart requires two group-by fields. Define another group-by field or use a different chart type.',
];
