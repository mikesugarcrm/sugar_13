...
$mod_strings = [
    ...
    'NTC_DELETE_CONFIRMATION_MULTIPLE' => 'Are you sure you want to delete the selected record(s)?<br>' .
        'Any users these record(s) have been shared with will also lose access.',
    'LBL_DELETE_DASHBOARD_CONFIRM' => 'Are you sure you want to delete the dashboard "{{name}}"?<br>' .
        'Any users this dashboard has been shared with will also lose access.',
