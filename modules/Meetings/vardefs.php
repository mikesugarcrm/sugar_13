...
$dictionary['Meeting'] = [
    ...
    'fields' => [
        'name' => [
            ...
            'dbType' => 'varchar',
            'unified_search' => true,
            'full_text_search' => ['enabled' => true, 'searchable' => true, 'boost' => 1.43],
            'len' => '255',
        ...
        'location' => [
            ...
            'full_text_search' => ['enabled' => true, 'searchable' => true, 'boost' => 0.36],
        ],
        'password' => [
            'name' => 'password',
            'vname' => 'LBL_PASSWORD',
        ...
        'date_start' => [
            ...
            'studio' => ['recordview' => false, 'wirelesseditview' => false],
        ...
        'date_end' => [
            ...
            'enable_range_search' => true,
            'options' => 'date_range_search_dom',
            'studio' => ['recordview' => false, 'wirelesseditview' => false], // date_end is computed by the server from date_start and duration
            'readonly' => true,
            'full_text_search' => ['enabled' => true, 'searchable' => false],
            'group' => 'end_date',
            'group_label' => 'LBL_DATE_END',
        ...
        'type' => [
            ...
            'default' => 'Sugar',
            'massupdate' => false,
            'studio' => ['wireless_basic_search' => false],
        ],
        ...
        'reminder_time' => [
            ...
            'studio' => ['recordview' => false, 'wirelesseditview' => false, 'previewview' => false],
        ],
        ...
        'recurrence_id' => [
            ...
            'vname' => 'LBL_RSET',
            'type' => 'text',
            'comment' => 'The RSet with RRule and EXDATE',
            'studio' => false,
            'reportable' => false,
            'hideacl' => true,
            ],
            ...
            'type' => 'varchar',
            'len' => 30,
            'comment' => 'Type of event(Master, Occurrence, Exception)',
            'studio' => false,
            'reportable' => false,
            'hideacl' => true,
            ],
        'ical_uid' => [
            ...
            'type' => 'varchar',
            'len' => 255,
            'comment' => 'Unique ID used by external calendars',
            'studio' => false,
            'reportable' => false,
            'hideacl' => true,
        ],
        'original_start_date' => [
            ...
            'vname' => 'LBL_ORIGINAL_DATE',
            'type' => 'datetimecombo',
            'dbType' => 'datetime',
            'comment' => ' Original Date of start of meeting',
            'studio' => false,
            'reportable' => false,
            'hideacl' => true,
        ],
    ...
    'relationships' => [
        'meetings_assigned_user' => ['lhs_module' => 'Users', 'lhs_table' => 'users', 'lhs_key' => 'id',
            'rhs_module' => 'Meetings', 'rhs_table' => 'meetings', 'rhs_key' => 'assigned_user_id',
            'relationship_type' => 'one-to-many']

        , 'meetings_modified_user' => ['lhs_module' => 'Users', 'lhs_table' => 'users', 'lhs_key' => 'id',
            'rhs_module' => 'Meetings', 'rhs_table' => 'meetings', 'rhs_key' => 'modified_user_id',
            'relationship_type' => 'one-to-many']

        , 'meetings_created_by' => ['lhs_module' => 'Users', 'lhs_table' => 'users', 'lhs_key' => 'id',
            'rhs_module' => 'Meetings', 'rhs_table' => 'meetings', 'rhs_key' => 'created_by',
            'relationship_type' => 'one-to-many']

        , 'meetings_notes' => ['lhs_module' => 'Meetings', 'lhs_table' => 'meetings', 'lhs_key' => 'id',
    ...
    'acls' => ['SugarACLOpi' => true, 'SugarACLStatic' => true],


    'indices' => [
        ['name' => 'idx_meet_par_del', 'type' => 'index', 'fields' => ['parent_id', 'parent_type', 'deleted']],
        ['name' => 'idx_meet_stat_del', 'type' => 'index', 'fields' => ['assigned_user_id', 'status', 'deleted']],
        ['name' => 'idx_meet_date_start_end_del', 'type' => 'index', 'fields' => ['date_start', 'date_end', 'deleted']],
        [
            'name' => 'idx_meet_repeat_parent_id',
            'type' => 'index',
            'fields' => ['repeat_parent_id', 'deleted'],
        ],
        // due to pulls from client side to check if there are reminders to handle.
        ['name' => 'idx_meet_date_start_reminder', 'type' => 'index', 'fields' => ['date_start', 'reminder_time']],
...
VardefManager::createVardef('Meetings', 'Meeting', [
    'default',
    'assignable',
    'team_security',
