...
$dictionary['Call'] = [
    ...
    'fields' => [
        'name' => [
            ...
            'unified_search' => true,
            'full_text_search' => ['enabled' => true, 'searchable' => true, 'boost' => 1.41],
            'required' => true,
            'importable' => 'required',
        ],
        'internal_notes' => [
    ...
    'indices' => [
        ...
        [
            ...
            'type' => 'index',
            'fields' => ['date_start', 'date_end', 'deleted'],
        ],
        [
        ...
        [
            ...
            'type' => 'index',
            'fields' => ['date_start', 'reminder_time'],
        ],
        [
        ...
        ['name' => 'idx_call_direction', 'type' => 'index', 'fields' => ['direction']],
        [
...
VardefManager::createVardef('Calls', 'Call', [
    'default',
    'assignable',
    'team_security',
