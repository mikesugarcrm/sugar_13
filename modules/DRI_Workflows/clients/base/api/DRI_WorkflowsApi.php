...
class DRI_WorkflowsApi extends SugarApi
{
    ...
    {
        $data = [];
        $childActivitiesCount = $args['childActivitiesCount'];
    ...
    public function updateActivityState(ServiceBase $api, array $args)
    {
        ...
        $this->validateAndUpdateActivityStatus('DRI_Workflows', $args['activity_id'], $args['activity_module'], $args['status']);
   ...
   /**
     ...
     * @throws SugarApiExceptionInvalidParameter
     */
    public function validateAndUpdateActivityStatus(string $targetModuleName, string $activityID, string $activityModule, string $updatedActivityStatus)
    {
