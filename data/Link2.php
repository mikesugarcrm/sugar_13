...
class Link2
{
    ...
    public function __construct($linkName, $bean, $linkDef = false)
    {
        ...
        if (!$this->loadedSuccesfully()) {
            global $app_strings;
            $GLOBALS['log']->error(string_format($app_strings['ERR_DATABSE_RELATIONSHIP_QUERY'], [$this->name, $this->def['relationship']]));
        }
     ...
     */
    public function getBeans($params = [], $retrieveParams = [])
    {
