...
({
    ...
    initialize: function(options) {
        ...
        app.events.on('timeline:link:added timeline:link:removed', this.handleLinkChanges, this);
    },
     ...
     * @param {Object} model
     */
    handleLinkChanges: function(parentModel, model) {
        let baseRecord = this.context.get('parentModel');
        if (parentModel && model && this.module === model.get('_module') &&
            baseRecord.get('id') === parentModel.get('id') &&
            baseRecord.get('_module') === parentModel.get('_module')) {
     ...
     */
    _dispose: function() {
        app.events.off('timeline:link:added timeline:link:removed', this.handleLinkChanges, this);
