...
({
    ...
    initialize: function(options) {
        ...
        app.events.on('timeline:link:added', this.handleLinkChanges, this);
    },
        ...
        var RelatedActivityCollection = app.MixedBeanCollection.extend({
            ...
            buildURL: _.bind(function(params) {
                ...
                this.activityModules.map((module) => {
                    params.field_list = params.field_list || {};

                    if (_.isArray(this.moduleFieldNames[module])) {
                        params.field_list[module] = this.moduleFieldNames[module].join(',');
                    }
                });
            ...
            sync: function(method, model, options) {
                ...
                if (self.searchTerm) {
                    ...
                    let moduleFilters = {};
                    _.each(self.activityModules, function(module) {
                        moduleFilters[module] = filtersBeanPrototype.buildSearchTermFilter(
                            module, self.searchTerm);
                    });
                    options.params.module_filters = moduleFilters;
                }
    ...
    createRecord: function(event, params) {
        ...
        app.drawer.open({
            ...
            app.events.trigger('timeline:link:added', self.baseRecord, model);
        });
    },
    ...
    getModuleLink: function(moduleName) {
        ...
        return cardMeta.link || moduleName.toLowerCase();
    },
