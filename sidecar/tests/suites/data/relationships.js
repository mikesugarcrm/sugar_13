...
describe('Data.Relationships', function() {
    ...
    describe("Utils", function() {
        ...
        describe('getRelationFields', function() {
            it('should get relationship fields', function() {
                let fields = dm.getRelationFields('Opportunities', 'contacts');
                expect(fields).toEqual(['contact_role', 'contact_other_rel_field']);

                fields = dm.getRelationFields('Contacts', 'opportunities');
                expect(fields).toEqual(['opportunity_role']);
            });
        });

        //Deprecated method test.
        describe('getRelationshipFields', function() {
    ...
    describe("CRUD", function() {
        ...
        it("should be able to create a related bean with all fields", function() {
        ...
        it("should be able to create a related bean with only passed fields", function() {
            var opportunity = dm.createBean("Opportunities"), contact;
            opportunity.id = "1";
            contact = dm.createRelatedBean(opportunity, null, "contacts", {
                first_name: "John",
            ...
            contact.save(null, { relate: true, fields: ["first_name", "last_name", "opportunity_role"] });
            server.respond();

            expect(server.requests[0].requestBody).toEqual('{"first_name":"John","last_name":"Smith","opportunity_role":"Influencer"}');
            expect(contact.id).toEqual("2");
            expect(contact.get("date_modified")).toBeDefined();
            expect(contact.link.isNew).toBeFalsy();
            expect(opportunity.get("date_modified")).toBeDefined();
        ...
        it("should be able to update a relationship", function() {
            ...
            contact.save(null, { relate: true, fields: ["id", "opportunity_role"] });
            server.respond();
