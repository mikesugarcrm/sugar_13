...
class StoredXssInPackagePluralLabelRegression extends SugarCRMRegression
{
    public function getRegressionDescription(): string
    {
        return "[BR-10466]: Stored XSS via Plural Label field allows to attack all the user's in the organization.";
    }
