...
class PortalContactInfoRegression extends SugarCRMRegression
{
    /**
     * @return string
     */
    ...
    {
        return '[BR-10870]: Stored XSS on Portal via contactInfo[contactURL] parameter';
    }
    ...
    public function run(): void
    {
        ...
        $this
            ...
            ->expectRegexp(
                "~this\.contactInfo\.contactURL\s*=\s*app\.config\.siteUrl\s*\+\s*this\.contactInfo\.contactURL\.trim\(\)~is",
            );
    }
