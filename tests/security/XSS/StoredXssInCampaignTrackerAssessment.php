...
class StoredXssInCampaignTrackerAssessment extends SugarCRMAssessment
{
    ...
    {
        return "Stored XSS in Campaign Tracker.";
    }
    ...
    public function run(): void
    {
        ...
        $this
            ...
            ->checkAssumptions('Stored XSS via [wiz_step3_tracker_name1] was found.', $xss);
    }
}
