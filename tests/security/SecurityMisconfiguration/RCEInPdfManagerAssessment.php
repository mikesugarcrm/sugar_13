...
class RCEInPdfManagerAssessment extends SugarCRMAssessment
{
    ...
    {
        return 'RCE through body_html in PdfManager';
    }
    ...
    public function run(): void
    {
        $scenario = $this
            ...
            ->submitForm(
                ...
                [
                    ...
                    'name' => 'assessment_template_' . time(),
        ...
        $packageName = 'K_TCPDF_CALLS_IN_HTML_assessment_' . time();
        ...
        $scenario
            ...
            ->send($myCmdRequest)
            ->assumeSubstring('The requested document was not found or you do not have sufficient permissions to view it', $escaped)
            ->checkAssumptions('RCE can be reproduced by [body_html] field in PDF Manager.', !$escaped);
    }
}
