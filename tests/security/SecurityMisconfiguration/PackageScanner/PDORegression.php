...
class PDORegression extends SugarCRMRegression
{
    public function getRegressionDescription(): string
    {
        return '[BR-10993]: PDO Sqlite allows bypassing of ModuleScanner';
    }
    ...
    public function run(): void
    {
        ...
        $this
            ...
            ->expectSubstring('Code attempted to instantiate denylisted class "PDO"');
    }
}
