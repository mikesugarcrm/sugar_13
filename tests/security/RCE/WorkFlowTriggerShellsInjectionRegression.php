...
class WorkFlowTriggerShellsInjectionRegression extends SugarCRMRegression
{
    public function getRegressionDescription(): string
    {
        return 'BR-10935: RCE through malicious "WorkFlow" and "WorkFlowTriggerShells"';
    }
    ...
    public function run(): void
    {
        ...
        $this->get("index.php?module=WorkFlow&action=SaveSequence&workflow_id={$workflow_id}")
            ->expectSubstring('Security violation in Workflow file');
    }
}
