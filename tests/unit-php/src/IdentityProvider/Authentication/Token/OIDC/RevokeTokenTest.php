...
/**
 * @coversDefaultClass \Sugarcrm\Sugarcrm\IdentityProvider\Authentication\Token\OIDC\RevokeToken
 */
class RevokeTokenTest extends TestCase
{
    ...
    {
        $this->token = new RevokeToken('test-token');
        parent::setUp();
    }
    ...
    {
        $this->assertEquals('test-token', $this->token->getCredentials());
    }
}
