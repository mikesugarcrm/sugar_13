...
/**
 * @coversDefaultClass Sugarcrm\Sugarcrm\Reports\Charts\ChartFactory
 */
class ChartFactoryTest extends TestCase
{
    public function providerGetChart()
    {
        return [
            [
                'type' => 'funnelF',
     ...
     * Test getChart
     *
     * @dataProvider providerGetChart
     */
    public function testGetChart($type, $data, $reportDef)
    {
