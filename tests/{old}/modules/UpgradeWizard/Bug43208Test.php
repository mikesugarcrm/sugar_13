...
class Bug43208Test extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        } elseif (!file_exists('custom/Extension/application/Ext/TableDictionary')) {
...
EOQ;
        ...
        } elseif (!file_exists('custom/application/Ext/TableDictionary')) {
...
{
    $tableDictionaryExtDirs = ['custom/Extension/application/Ext/TableDictionary', 'custom/application/Ext/TableDictionary'];
