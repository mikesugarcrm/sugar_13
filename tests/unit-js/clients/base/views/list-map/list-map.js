 ...
 */
describe('Base.Views.ListMap', function() {
    var app;
    var view;
    var viewName = 'list-map';
    var button;
    var initOptions;
    ...
    beforeEach(function() {
        ...
        SugarTest.loadHandlebarsTemplate(viewName, 'view', 'base', 'list-map');
    ...
    describe('createMap', function() {
        beforeEach(function() {
            view = SugarTest.createView('base', '', viewName, 'list-map');
