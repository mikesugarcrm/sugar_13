 ...
 */
describe('Base.View.Stage2EmailImport', function() {
    var app;
    var view;
    var module;
    var context;
    ...
    beforeEach(function() {
        ...
        view = SugarTest.createView('base', module, 'stage2-email-import');
    ...
    describe('initialize()', function() {
        ...
        it('should add listeners', function() {
            expect(view.events['change input[name=checkbox-import]']).toEqual('isChecked');
            expect(view.events['click .save_import']).toEqual('saveImport');
