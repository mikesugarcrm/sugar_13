 ...
 */
describe('Administration.Views.MapsModuleWidgetView', function() {
    var app;
    var sandbox = sinon.createSandbox();
    var viewName = 'maps-module-widget';
    ...
    describe('initialize()', function() {
        ...
        it('should properly set widgetModule property', function() {
            expect(testView.widgetModule).toEqual('Accounts');
        });
    });
});
