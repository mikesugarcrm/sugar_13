 ...
 */
describe('Administration.Views.ActionbuttonAssignRecordView', function() {
    var app;
    var sandbox = sinon.createSandbox();
    var viewName = 'actionbutton-assign-record';
    ...
    describe('render()', function() {
        ...
        it('should properly create field controller', function() {
            expect(testView.userSelectField).toNotEqual(null);
            expect(testView.userSelectField.type).toEqual('relate');
        });
    });
