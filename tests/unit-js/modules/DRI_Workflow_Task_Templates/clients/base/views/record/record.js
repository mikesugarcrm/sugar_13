...
describe('DRI_Workflow_Task_Templates.Views.Record', function() {
    ...
    describe('hasUnsavedChanges', function() {
        ...
        function(input) {
            it('should call changedAttributes if expected and hasUnsavedChanges response should be as input result',
                function() {
                    ...
                    if (input.resavingAfterMetadataSync) {
                        expect(view.model.changedAttributes).not.toHaveBeenCalled();
                    } else {
