 ...
 */
describe('Metrics.Fields.FieldList', function() {
    var app;
    var field;
    var model;
    var fields;
    ...
    describe('initialize', function() {
        it('should call getTabContentFields once', function() {
            var getTabContentFieldsSpy = sinon.spy(field, 'getMappedFields');
